...
public class StopWordRemoval {
    ...
    public static HashSet<String> stop_word_hs = new HashSet<String>(Arrays.asList(stop_word_list));
    ...
    public static ArrayList<String> removeStopWords(String str) {
        ...
        ArrayList<String> curated_words = new ArrayList<String>();

        for (String str2 : temp) {
            if (!stop_word_hs.contains(str2)) {
                curated_words.add(str2);
    ...
    public static void main(String[] args) {
        ...
        ArrayList<String> curated_words = removeStopWords(str);
        System.out.println(curated_words.size());
        System.out.println(curated_words);
    }
}
